...
library(randomForest)
# 
rf1 = randomForest(value~tmin+rad+tci+elv+coords.x1+coords.x2+station, data = training, na.action = na.omit, ntree =500)
...
# glm1 = glm(value~tmin+elv+tci+rad+coords.x1+coords.x2, data = training, na.action = na.omit)
